  ...
  tt.defineMode("javascript", function (e, l) {
    ...
    function D(e, t) {
      return "var" == e
        ...
        ? $()
        : "if" == e
        ? ("else" == I.state.lexical.info &&
            I.state.cc[I.state.cc.length - 1] == H &&
            I.state.cc.pop()(),
          $(F("form"), L, D, H, $e))
        : "function" == e
        ? $(qe)
        ...
        ? ((I.marked = "keyword"), $(F("form", "class" == e ? e : t), Be, H))
        : "variable" == e
        ? u && "declare" == t
          ? ((I.marked = "keyword"), $(D))
          : u &&
          ...
          ? ((I.marked = "keyword"),
            "enum" == t
              ...
              : "type" == t
              ? $(Se, W("operator"), ye, W(";"))
              : $(F("form"), Ve, W("{"), F("}"), de, H, H))
          : u && "namespace" == t
          ? ((I.marked = "keyword"), $(F("form"), J, D, H))
          : u && "abstract" == t
          ? ((I.marked = "keyword"), $(D))
          : $(F("stat"), ie)
        : "switch" == e
        ? $(F("form"), L, W("{"), F("}", "switch"), U, de, H, H, B)
        : "case" == e
        ? $(J, W(":"))
        : "default" == e
        ? $(W(":"))
      ...
      if ("variable" == e || "keyword" == I.style) {
        return ((I.marked = "property"), "get" == t || "set" == t)
          ...
          : (u &&
              ...
              (r = I.stream.match(/^\s*:\s*/, !1)) &&
              (I.state.fatArrowAt = I.stream.pos + r[0].length),
            $(ue));
        var r;
      } else {
    ...
    function xe(e, t) {
      return ("variable" == e && I.stream.match(/^\s*[?:]/, !1)) || "?" == t
        ? $(xe)
        : ":" == e
        ? $(ye)
        : "spread" == e
    ...
    function Fe(e, t) {
      return "<" == t
        ...
        ? ("implements" == t && (I.marked = "keyword"), $(u ? ye : J, Fe))
        : "{" == e
        ? $(F("}"), He, H)
        : void 0;
    }
    ...
    function De(e, t) {
      return "*" == t
        ? ((I.marked = "keyword"), $(Re, W(";")))
        : "default" == t
        ? ((I.marked = "keyword"), $(J, W(";")))
        : "{" == e
        ? $(fe(Ge, "}"), Re, W(";"))
        : T(D);
    }
    ...
    function Ke(e, t) {
      return "{" == e
        ? le(Ke, "}")
        : ("variable" == e && _(t), "*" == t && (I.marked = "keyword"), $(Qe));
    }
    function Le(e) {
      if ("," == e) return $(Ke, Le);
    }
